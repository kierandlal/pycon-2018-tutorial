...
# MAGIC 
# MAGIC ![img](http://training.databricks.com/databricks_guide/gentle_introduction/help_menu.png)
# MAGIC 
...
# MAGIC 
# MAGIC -   ****The Dataset****
# MAGIC     -   The Dataset is Apache Spark's newest distributed collection and can be considering a combination of DataFrames and RDDs. It provides the typed interface that is available in RDDs while providing a lot of conveniences of DataFrames. It will be the core abstraction going forward.
# MAGIC -   ****The DataFrame****
...
# MAGIC 
# MAGIC *If you're in the Community Edition of Databricks, this will all happen automatically once you start running cells in a notebook! However you're free to follow the below directions if you wish.*
# MAGIC 
# MAGIC Click the Clusters button that you'll notice on the left side of the page. On the Clusters page, click on ![img](http://training.databricks.com/databricks_guide/create_cluster.png) in the upper left corner.
# MAGIC 
# MAGIC Then, enter the configuration for the new cluster:
# MAGIC 
# MAGIC ![img](http://training.databricks.com/databricks_guide/create_cluster_2.13v1.png)
# MAGIC 
# MAGIC Finally, 
# MAGIC 
# MAGIC -   Select a unique name for the cluster.
# MAGIC -   Select the Spark Version.
# MAGIC     -   Optionally, you can test out experimental versions of Spark.
# MAGIC -   Enter the number of workers to bring up - at least 1 is required to run Spark commands.
# MAGIC -   Select whether to use On-Demand Instances, Spot Instances, or a combination of both.
# MAGIC 
...
# MAGIC 
# MAGIC ![img](http://training.databricks.com/databricks_guide/gentle_introduction/spark-dag-ui-before-2-0.png)
# MAGIC 
# MAGIC or
# MAGIC 
